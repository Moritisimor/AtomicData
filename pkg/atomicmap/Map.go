...
// AtomicMap is a thread-safe map-wrapper.
...
// New creates a new empty, thread-safe map.
...
// From Creates a new thread-safe map from an existing map.
...
// Get method for getting a value with a key.
...
// Set Method for setting a value with a key.
...
// SetIfNotExists Method for setting value with a key if it does not exist.
...
// Update Method for updating a value with its key.
...
// Delete Method for deleting value with a key.
