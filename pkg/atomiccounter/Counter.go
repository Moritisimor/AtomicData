...
// AtomicCounter is a wrapper over an Atomic 64-bit Integer.
...
// Increment method for incrementing the counter.
// It will return the new value which the counter holds.
func (c *AtomicCounter) Increment() int64 {
	return c.internalcounter.Add(1)
}

// IncrementBy method for incermenting the counter by a set number.
...
// Decrement Method for decrementing the counter.
// It will return the new value of the counter.
func (c *AtomicCounter) Decrement() int64 {
	return c.internalcounter.Add(-1)
}

// DecrementBy for decrementing the counter by a set number.
